...
const BikeInfoForm = () => {
    ...
    const removeImage = (index) => {
        ...
        setBikeImages(bikeImages.filter((_, i) => i !== index));
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.status === 201) {
                console.log('bikeCreated', res.data);
                navigate(`/payment/${res.data.bike?._id}`)
                Swal.fire({
                    icon: 'success',
                ...
                <div className="relative bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-t-2xl p-8 text-center text-white shadow-lg overflow-hidden">
                    <div className="relative z-10">
                        ...
                        <p className="text-lg max-w-2xl mx-auto opacity-90">
                            Please fill in the details of your bike to list it for sale – provide accurate information 
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="border-b border-gray-200 pb-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="block w-full rounded-md border border-gray-300 shadow-sm py-2 px-3 focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400"
                                    required
                                    placeholder="Write a detailed description including features, upgrades, maintenance history..."
                                ></textarea>
                            </div>
                            <div className="mt-6">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="block w-full rounded-md border border-gray-300 shadow-sm py-2 px-3 focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400"
                                    placeholder="Any additional notes for administrators"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="border-2 border-dashed border-yellow-300 bg-yellow-50 rounded-lg p-6 text-center hover:bg-yellow-100 transition-colors">
                                <label htmlFor="bikeImage" className="cursor-pointer block">
                                    <div className="mb-3">
                                        <span className="text-sm font-medium text-yellow-700">Click to upload bike images</span>
                                    </div>
                                    <input
                                        type="file"
                                        id="bikeImage"
